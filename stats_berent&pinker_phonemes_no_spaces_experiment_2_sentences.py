...
df = pd.read_csv("results_berent&pinker_phonemes_no_spaces_experiment_2_sentence.csv")
...
output_filename = "res_stats_berent_pinker_phonemes_no_spaces_experiment_2_sentence.csv"
