...
for model_name in models:
    ...
    if "causal" in model_name:
        output_file = "results_berent&pinker/10M/results_experiment_3_gpt_bert_10M_causal_stories.csv"
    elif "mixed" in model_name:
        output_file = "results_berent&pinker/10M/results_experiment_3_gpt_bert_10M_mixed_stories.csv"
    else:
        output_file = "results_berent&pinker/10M/results_experiment_3_gpt_bert_10M_masked_stories.csv"
