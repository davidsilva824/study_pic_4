...
for model_name in models:
    ...
    if "causal" in model_name:
        output_file = "results_berent&pinker/10M/results_experiment_2_gpt_bert_10M_causal.csv"
    
    elif "mixed" in model_name:
        output_file = "results_berent&pinker/10M/results_experiment_2_gpt_bert_10M_mixed.csv"

    else:
        output_file = "results_berent&pinker/10M/results_experiment_2_gpt_bert_10M_masked.csv"
