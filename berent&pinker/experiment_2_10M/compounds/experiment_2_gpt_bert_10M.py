...
for model_name in models:
    ...
    if "causal" in model_name:
        output_file = "results_berent&pinker/results_experiment_2_gpt_bert_10M_causal_compounds.csv"
    elif "mixed" in model_name:
        output_file = "results_berent&pinker/results_experiment_2_gpt_bert_10M_mixed_compounds.csv"
    else:
        output_file = "results_berent&pinker/results_experiment_2_gpt_bert_10M_masked_compounds.csv"
