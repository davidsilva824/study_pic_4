###### NOT WORKING ############
# limits of tokens surpassed by some of the sentences.
...
### + MINIMAL CHANGE: read compounds from CSV instead of hardcoded `compound_groups`
...
def process_pairs(lm, pairs, data):
    ...
    for _, row in stimuli_df.iterrows():
        ...
        sentence = str(row["compound"]).strip()   # use your actual compound column name
