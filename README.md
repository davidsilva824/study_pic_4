...
Run 'experiment_1_model.py' files to obtain the results for each model for the combination of compounds for experiment 3.

Run 'stats_experiment_1.py' files to obtain the initial statistics for each model in the experiment 3. 
