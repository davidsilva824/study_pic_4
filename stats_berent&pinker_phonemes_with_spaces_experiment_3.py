...
df = pd.read_csv("results_berent&pinker_phonemes_with_spaces_experiment_3.csv")
...
output_filename = "res_stats_berent_pinker_phonemes_with_spaces_experiment_3.csv"
