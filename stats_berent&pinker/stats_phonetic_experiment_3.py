...
file_list = [
    "results_berent&pinker/results_experiment_3_babble_phonetic_BPE_stories.csv",
    "results_berent&pinker/results_experiment_3_babble_phonetic_cha_stories.csv",
    "results_berent&pinker/results_experiment_3_babble_txt_BPE_stories.csv",
    "results_berent&pinker/results_experiment_3_grapheme_llama_stories.csv",
    "results_berent&pinker/results_experiment_3_phoneme_llama_stories.csv",
]
