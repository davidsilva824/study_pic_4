...
df2 = pd.read_csv("res_stats_berent_pinker_phonemes_with_spaces_experiment_2.csv")
df3 = pd.read_csv("res_stats_berent_pinker_phonemes_with_spaces_experiment_3.csv")
...
plt.tight_layout()
plt.savefig("graphic_display_berent&pinker_1.png")
